...
- web2wave deferred deeplinks via `identify()` (MMP-free alternative to AppsFlyer / Adjust / Branch)
...
Resolves a user via web2wave deferred deeplinks. Alternative to MMP-based deeplink attribution when you do not use AppsFlyer, Adjust, Branch, etc.
